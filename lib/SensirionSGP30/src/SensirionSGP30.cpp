...
*/
/**************************************************************************/
boolean SensirionSGP30::begin(TwoWire *theWire) {
...
*/
/**************************************************************************/
boolean SensirionSGP30::IAQinit(void) {
  uint8_t command[2];
  command[0] = 0x20;
  command[1] = 0x03;
...
*/
/**************************************************************************/
boolean SensirionSGP30::IAQmeasure(void) {
  uint8_t command[2];
  command[0] = 0x20;
  command[1] = 0x08;
  uint16_t reply[2];
...
*/
/**************************************************************************/
boolean SensirionSGP30::getIAQBaseline(uint16_t *eco2_base, uint16_t *tvoc_base) {
  uint8_t command[2];
  command[0] = 0x20;
  command[1] = 0x15;
  uint16_t reply[2];
...
*/
/**************************************************************************/
boolean SensirionSGP30::setIAQBaseline(uint16_t eco2_base, uint16_t tvoc_base) {
  uint8_t command[8];
  command[0] = 0x20;
  command[1] = 0x1e;
...
boolean SensirionSGP30::readWordFromCommand(uint8_t command[], uint8_t commandLength, uint16_t delayms, uint16_t *readdata, uint8_t readlen)
{
  uint8_t data;
...
uint8_t SensirionSGP30::generateCRC(uint8_t *data, uint8_t datalen) {
